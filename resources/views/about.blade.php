    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">DA_ED8, ganda putra, ganda putri+1</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('meet1.jpeg')}}" class="card-img rounded-2" alt="...">
                        <p>First Meeting, yang penting kumpul dulu, ngobrol santai nyebutin nama, asal, universitas, jurusan, NIM, kesibukan dll</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('meet2.jpeg')}}" class="card-img rounded-2" alt="...">
                        <p>Next Meeting, gapapa offcam, yang penting kumpul</p>
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-lg-5 position-relative">
				...
				<!-- Image -->
				<img src="{{asset('with.jpeg')}}" class="rounded" alt="">
			</div>

			<div class="col-lg-7 mt-4 mt-lg-0">
				<!-- Title -->
				<h4 class="mb-3">DA_ED8</h4>

				<!-- Content -->
				<p>Grup yang sering dipakai untuk koordinasi dengan mentor terkait project dan mentoring</p>


				<!-- Info -->
				<ul class="list-group list-group-borderless mt-4">
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Ngomongin sumber data
					</li>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Ngomongin jadwal mentoring
					</li>
                    <li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Agak sepi
					</li>
	...
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-lg-5 position-relative">
				...
				<!-- Image -->
				<img src="{{asset('without.jpeg')}}" class="rounded" alt="">
			</div>

			<div class="col-lg-7 mt-4 mt-lg-0">
				<!-- Title -->
				<h4 class="mb-3">DA_ED8 tanpa mentor</h4>

				<!-- Content -->
				<p>Grup yang sering dipakai untuk diskusi project, meeting mandiri dulu tanpa mentor (hampir tiap minggu 1-2x)</p>


				<!-- Info -->
				<ul class="list-group list-group-borderless mt-4">
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Ngomongin data, narasi, deskripsi
					</li>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Ngomongin jadwal mentoring
					</li>
                    <li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Rame
					</li>
                    <li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>React jempol dan 🙏 sering dipakai
					</li>
                                        <li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>Tidak lupa haha, hihi, wkwk
					</li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 mb-4 mb-md-0">
				<!-- Title -->
				<h5>Our Timeline (30 May 2022 - 3 July 2022)</h5>
				<!-- Content -->
				<ul class="list-group list-group-borderless mt-4">
					<!-- Award item -->
                    <li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 1-2</h6>
						<span class="fs-6 ms-3">Meet and talk about project</span>
					</li>
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 3</h6>
						<span class="fs-6 ms-3">Creating Project Proposal</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 4</h6>
						<span class="fs-6 ms-3">Review and Evaluation</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 5</h6>
						<span class="fs-6 ms-3">Data Collecting, Maturation of selected concepts and problems (still mentoring)</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 6-7</h6>
						<span class="fs-6 ms-3">Data Collecting, Data Cleaning, Data Processing, Data Visualization (still mentoring)</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">Week 8</h6>
						<span class="fs-6 ms-3">"eh besok tuh deadlinenya jam berapa, eh datanya ada yang kurang, ini gausah dimasukin, kapan bahas ppt, haha-hihi-wkwk" - tiba - tiba jadi</span>
					</li>
					<!-- Award item -->
			...
			<div class="col-md-8">
				...
				<div class="d-sm-flex justify-content-sm-between">
					<h2 class="mb-0">Meet Our SuperTeam</h2>
				</div>
					...
					<div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items="5" data-items-lg="5" data-items-md="5">
                        ...
                        <div class="text-center">
							...
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="{{asset('mentor.jpeg')}}" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Muhammad Asadullah Al Ghozi</a></h6>
							<p class="mb-0 small">Our Mentor</p>
							<!-- Rating -->
						...
						<div class="text-center">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="https://pps.whatsapp.net/v/t61.24694-24/258772779_508864467397226_4233416170047814782_n.jpg?ccb=11-4&oh=01cc4c1cafe97742c18b64f1f37e97ec&oe=62C9A066" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Fauzan Amir Al Ghiffary</a></h6>
							<p class="mb-0 small">Data Cleaner and Processor, Database Designer, Backend Developer</p>
							<!-- Rating -->
							<!-- <ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
						...
						<div class="text-center">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="https://cdn.discordapp.com/avatars/935040469459677214/1cd9116bb2472163f8d34ba1d87bcbf3.webp?size=480" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Amelia Calvina Savitri</a></h6>
							<p class="mb-0 small">Data Analyst, Processor and Collector, Narrator </p>
							<!-- Rating -->
							<!-- <ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
						...
						<div class="text-center">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="https://cdn.discordapp.com/avatars/868875556781957140/b73e89a96ff786c52bd8eefc6375a80c.webp?size=480" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Fimadasa Blesofi Fikansa</a></h6>
							<p class="mb-0 small">Data Scientist, Analyst, Processor and Collector, Narrator</p>
							<!-- Rating -->
							<!-- <ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
						...
						<div class="text-center">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="https://cdn.discordapp.com/avatars/757990522894942219/497963c8fcb7c3abe934a5768c0ff7d3.webp?size=480" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Devi Nopriyani</a></h6>
							<p class="mb-0 small">Data Processor and Collector, Narrator</p>
							<!-- Rating -->
							<!-- <ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
						...
						<div class="text-center">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="https://pps.whatsapp.net/v/t61.24694-24/289026443_4940722119365007_1128489090304638160_n.jpg?ccb=11-4&oh=01_AVwMHC40aZxHabsYv1FMaq2J4I7nZ9POsqYFhUumd-3ypQ&oe=62CB1CF9" alt="avatar">
							</div>
							<!-- Info -->
							<h6 class="mb-0"><a href="#">Darren</a></h6>
							<p class="mb-0 small">Data Engineer, Processor and Collector and Frontend Developer</p>
							<!-- Rating -->
							<!-- <ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
