    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Digital Literacy Index in Indonesia</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('index-literacy.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Literacy Rate in Indonesia</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('rate.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Internet Availability</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('inet.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Having Mobile Phone</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('phone.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Literacy Rate (AMH)</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('amh.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Not Attending School</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('school.png')}}" class="card-img rounded-2" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Digital Literacy Index</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-8 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
            <!-- Image -->
                        <img src="{{asset('id.jpeg')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('tech.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('com.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('info.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('think.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('ethic.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('data.png')}}" class="card-img rounded-2" alt="...">
                        <img src="{{asset('sec.png')}}" class="card-img rounded-2" alt="...">
