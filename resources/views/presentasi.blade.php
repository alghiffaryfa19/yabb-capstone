    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">Presentation</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
        ...
        <div class="row">
            <div class="col-md-12 text-center mx-auto">
                <div class="card card-body shadow p-2">
                    <div>
                        <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vRX8u5Z8cIhRHM-E_jV-SWEklYptCynxUKuSiBHKHbC3mq7ExKbm4LzY5z6_QL_YA/embed?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="569" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                    </div>
                </div>
            </div>
        </div>
